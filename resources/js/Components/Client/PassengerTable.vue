        ...
        <table class="table-auto w-full">
            ...
            <tbody>
                <tr v-for="passenger in passengers" :key="passenger.id">
                    <td class="border px-4 py-2">{{ passenger.id }}</td>
                    <td class="border px-4 py-2">{{ passenger.first_name }}</td>
                    <td class="border px-4 py-2">{{ passenger.last_name }}</td>
                    <td class="border px-4 py-2">{{ passenger.gender }}</td>
                    <td class="border px-4 py-2">{{ passenger.date_of_birth }}</td>
                    <td class="border px-4 py-2">{{ passenger.nationality }}</td>
                    <td class="border px-4 py-2 flex space-between">
