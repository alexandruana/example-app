...
function editPassenger(passenger) {
    selectedPassenger.value = { ...passenger }; // Clone the passenger to avoid direct mutation
}

const updatePassenger = (updatedPassenger) => {
// Find and update the passenger in the passengers array
}
            ...
            <div class="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle">
                    ...
                    <Modal :show="selectedPassenger" @close="selectedPassenger = null">
                        <EditPassenger :passenger="selectedPassenger"/>
                    </Modal>
                </div>
            </div>
        </div>
