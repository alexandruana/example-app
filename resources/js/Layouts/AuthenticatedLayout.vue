...
<template>
        ...
        <div class="relative mr-16 flex w-full max-w-xs flex-1">
            ...
            <div class="flex h-16 shrink-0 items-center">
                <p class="text-sky-500">
                    <span class="text-white">JET</span>SUPPLY
                </p>
            </div>
            <nav class="flex flex-1 flex-col">
                ...
                <li>
                    ...
                    <li>
                        ...
                        <NavLink :href="route('dashboard')" :active="route().current('dashboard')" class="bg-gray-800 text-white group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    ...
                    <li>
                        <NavLink :href="route('trips.index')" :active="route().current('trips.index')" class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    ...
                    <li>
                        <NavLink :href="route('passengers.index')" :active="route().current('passengers.index')" class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        ...
        <div class="flex h-16 shrink-0 items-center self-center">
            <p class="text-2xl text-sky-500 font-extrabold">
                <span class="text-white">JET </span>SUPPLY
            </p>
        </div>
        <nav class="flex flex-1 flex-col">
            ...
            <li>
                ...
                <li>
                    <!-- Current: "bg-gray-800 text-white", Default: "text-gray-400 hover:text-white hover:bg-gray-800" -->
                    <NavLink :href="route('dashboard')" :active="route().current('dashboard')"  class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </svg>
                    Dashboard
