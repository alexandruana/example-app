<! - resources/views/companies/create/create.blade.php →
<!DOCTYPE html>
    <html>
        ...
        <div
            ...
            <div class="w-1/4">
                <div class="flex justify-center my-2 w-full">
                    <h1 class="text-xl font-bold my-2">Register Company</h1>
                </div>
                <hr>
                <form method="post" action="{{ route('companies.store') }}">
                    ...
                    <div class="flex flex-col gep-y-2">
                        ...
                        <input class="px-2 h-10 border border-black" type="text" name="company_name" required><br>
                    </div>
                    <div class="flex flex-col gep-y-2">
                        <label for="company_street">Company Street:</label>
                        <input class="px-2 h-10 border border-black" type="text" name="company_street" required><br>
                    </div>
                    <div class="flex flex-col gep-y-2">
                        <label for="company_postcode">Company Postcode:</label>
                        <input class="px-2 h-10 border border-black" type="text" name="company_postcode" required><br>
                    </div>
                    <div class="flex flex-col gep-y-2">
                        <label for="company_city">Company City:</label>
                        <input class="px-2 h-10 border border-black" type="text" name="company_city" required><br>
                    </div>
                    <div class="flex flex-col gep-y-2">
                        <label for="company_country">Company Country:</label>
                        <input class="px-2 h-10 border border-black" type="text" name="company_country" required><br>
                    </div>
                    <div class="flex flex-col gep-y-2">
